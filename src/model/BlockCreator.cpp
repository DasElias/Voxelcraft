...
namespace vc {
	Block* createBlock_inChunk(const int& inChunkX, const int& inChunkY, const int& inChunkZ, const std::shared_ptr<BlockType>& type, Chunk& chunk, Face placedOn, std::string metadata) {
	...
	Block* createBlock(const int& worldX, const int& worldY, const int& worldZ, const std::shared_ptr<BlockType>& type, Chunk& chunk, Face placedOn, std::string metadata) {
