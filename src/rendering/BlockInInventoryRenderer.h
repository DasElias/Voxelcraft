...
namespace vc {
	class BlockInInventoryRenderer : FreePositionableBlockRenderer {
		...
		// ----------------------------------------------------------------------
		public:
			void render(const std::shared_ptr<BlockType>&, const TextureArray& blockTextures, float absXMargin, float absYMargin, float width, float height, float opacity = 1);
	};
}	